...
export class initialState1649029285150 implements MigrationInterface {
    name = 'initialState1649029285150'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "bank_account" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "description" text NOT NULL, "name" text NOT NULL, "status" text NOT NULL, "operation" text NOT NULL, "balance" real NOT NULL, "company_id" integer NOT NULL, "updated_at" TIMESTAMP DEFAULT now(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "user_update" text, "user_insert" text, CONSTRAINT "PK_f3246deb6b79123482c6adb9745" PRIMARY KEY ("id"))`);
