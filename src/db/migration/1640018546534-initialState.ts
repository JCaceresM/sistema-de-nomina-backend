...
export class initialState1640018546534 implements MigrationInterface {
    name = 'initialState1640018546534'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "employee" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "document_id" text NOT NULL, "fist_name" text, "last_name" text, "gender" text, "age" integer, "marital_status" text, "status" text NOT NULL, "born_date" TIMESTAMP, "hire_date" TIMESTAMP, "nss" text, "nomina_id" text, "update_at" TIMESTAMP DEFAULT now(), "create_at" TIMESTAMP NOT NULL DEFAULT now(), "user_update" text, "user_insert" text, "department_id" uuid, "paysheet_id" uuid, CONSTRAINT "UQ_3d42008c12e986e37ee3bdebbd2" UNIQUE ("document_id"), CONSTRAINT "REL_6235aec369d04cb9e4691cc52d" UNIQUE ("paysheet_id"), CONSTRAINT "PK_3c2bc72f03fd5abbbc5ac169498" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_name" text NOT NULL, "email_login" text NOT NULL, "password" text NOT NULL, "update_at" TIMESTAMP DEFAULT now(), "create_at" TIMESTAMP NOT NULL DEFAULT now(), "user_update" text, "user_insert" text, "status" text, "employee_id" uuid, CONSTRAINT "UQ_4d217bc91b1ecf421818520ca1c" UNIQUE ("email_login"), CONSTRAINT "REL_9760615d88ed518196bb79ea03" UNIQUE ("employee_id"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
